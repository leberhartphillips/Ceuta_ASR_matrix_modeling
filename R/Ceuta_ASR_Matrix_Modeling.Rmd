...
chick <- 
  read.table("~/Dropbox/Luke/R_projects/Ceuta_ASR_Matrix_Modeling/data/chick_mark-recapture_data.txt",
...
breeding_data <- 
  read.table("~/Dropbox/Luke/R_projects/Ceuta_ASR_Matrix_Modeling/data/breeding_data.txt", 
             header = TRUE)
```
***
## Fecundity
