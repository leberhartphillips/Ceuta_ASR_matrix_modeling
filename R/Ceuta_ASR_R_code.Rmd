---
title: 'R-code for "Adult sex ratio bias is driven by sex-specific early survival: implications for mating system evolution and population growth"'
...
ggsave(Sex_specific_mating_plot,
       filename = "Eberhart-Phillips_et_al._Figure_1.tiff",
       path = "/Users/Luke/Documents/Academic_Projects/PhD/Ceuta_ASR_Matrix_Modeling/Writing/PNAS/Revision/to_resubmit/final/Figures",
       width = 3.42,
       height = 4, units = "in",
       dpi = 600,
       scale = 1)
...
Background <- 
  ...
  annotate("text", x = c(2,2), y = c(-Inf, Inf),
           label = c("\u2640", "\u2642"), size = 5,
           family="Franklin Gothic Book", vjust = c(0.5,0.5), hjust = c(-0.3,1.3)) +
...
Bootstrap_sex_diff_VR_plot <- 
  ...
  # ylab(paste("Sex bias in apparent survival", expression("\u03D5")))
  # ylab("Sex bias in apparent survival (phi)")
Bootstrap_sex_diff_VR_plot
# jpeg(filename = "/Users/Luke/Dropbox/Luke/R_projects/Ceuta_ASR_Matrix_Modeling/figs/final/final_final/Draft_5/Surv_sex_differences_final.jpeg",
#      quality = 100,
#      width = 4,
#      height = 4,
#      units = "in",
...
tiff(filename = "/Users/Luke/Documents/Academic_Projects/PhD/Ceuta_ASR_Matrix_Modeling/Writing/PNAS/Revision/to_resubmit/final/Figures/Eberhart-Phillips_et_al._Figure_2a.tiff",
     compression = "none",
     width = 3.42,
     height = 3.42,
     units = "in",
...
ggplot2::ggplot() +
          ...
          annotate("text", x = c(-Inf,Inf), y = c(70, 70),
                   label = c("\u2640", "\u2642"), size = 5,
                   family="Franklin Gothic Book", vjust = c(1.5,1.5), hjust = c(-0.5,1.5)) +
...
ggsave(ASR_bootstrap_histogram,
       filename = "Eberhart-Phillips_et_al._Figure_2b.tiff",
       path = "/Users/Luke/Documents/Academic_Projects/PhD/Ceuta_ASR_Matrix_Modeling/Writing/PNAS/Revision/to_resubmit/final/Figures",
       width = 3.42,
       height = 3.42, units = "in",
       dpi = 600,
       scale = 1)
```

**AIC model selection summary (panels in Supplementary Material Figure 2)**
...
# jpeg(filename = "/Users/Luke/Dropbox/Luke/R_projects/Ceuta_ASR_Matrix_Modeling/figs/final/final_final/AIC_multi_plot_juvenile_adult.jpeg",
#      quality = 100,
#      width = 6,
#      height = 9,
#      units = "in",
...
Background_LTRE_ASR <-
  ...
  theme(text = element_text(family="Franklin Gothic Book", 
        ...
        axis.title.x = element_text(size=10, margin = margin(10, 0, 0, 0)),
        axis.text.x  = element_text(size=8, margin = margin(5, 0, 0, 0)),
        axis.title.y = element_text(size=10, margin = margin(0, 12, 0, 0)),
        axis.text.y  = element_text(size=8, angle = 0, hjust = 1, 
                                    margin = margin(0, 5, 0, 0)),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        ...
        plot.margin = unit(c(1,0.5,0.5,1.95), "cm"),
        panel.margin = unit(0.75, "lines"),
        strip.background = element_blank(),
        strip.text = element_blank()) +
...
LTRE_ASR <-
  ...
  scale_x_discrete(labels = c("Adult survival" = expression(Adult["  "]),
                              "Juvenile survival" = expression(Juvenile["  "]),
                              "Chick survival" = expression(Chick["  "]),
                              "Hatching sex ratio" = expression(italic("\u03C1")),
                              "Mating system" = expression(italic("h"))))
  # scale_x_discrete(labels = c("Adult survival" = expression(Adult["\u03D5"]),
  #                             "Juvenile survival" = expression(Juvenile ["\u03D5"]),
...
# Save the plot
# jpeg(filename = "/Users/Luke/Dropbox/Luke/R_projects/Ceuta_ASR_Matrix_Modeling/figs/final/final_final/Draft_5/LTRE_mating_function_ASR.jpeg",
#      quality = 100,
#      width = 4,
#      height = 4,
#      units = "in",
...
tiff(filename = "/Users/Luke/Documents/Academic_Projects/PhD/Ceuta_ASR_Matrix_Modeling/Writing/PNAS/Revision/to_resubmit/final/Figures/Eberhart-Phillips_et_al._Figure_2c.tiff",
     width = 3.42,
     height = 3.42,
     units = "in",
     res = 600,
...
lambda_elasticity <- 
  ggplot2::ggplot() +
          ...
          annotate("text", x = c(3), y = c(-0.375),
                   label = c("\u2640"),
                   size = 5,
                   family="Franklin Gothic Book", vjust = c(0.5)) +
          annotate("text", x = c(3), y = c(0.375),
                   label = c("\u2642"),
                   size = 5,
                   family="Franklin Gothic Book", vjust = c(0.5)) +
          ...
          scale_x_discrete(labels = c("Adult_survival" = "Adult  ",
                                      "Juvenile_survival" = "Juvenile  ",
                                      "Chick_survival" = "Chick  ",
...
lambda_elasticity
ggplot2::ggsave(filename = "lambda_elasticity,Eberhart-Phillips_et_al._Figure_3.tiff",
                path = "/Users/Luke/Documents/Academic_Projects/PhD/Ceuta_ASR_Matrix_Modeling/Writing/PNAS/Revision/to_resubmit/final/Figures/",
                width = 3.42,
                height = 6, units = "in",
                dpi = 600,
...
ggsave(lambda_histogram,
       filename = "lambda_elasticity,Eberhart-Phillips_et_al._Figure_4.tiff",
       path = "/Users/Luke/Documents/Academic_Projects/PhD/Ceuta_ASR_Matrix_Modeling/Writing/PNAS/Revision/to_resubmit/final/Figures/",
       width = 3.42,
       height = 3.42, units = "in",
       dpi = 600,
