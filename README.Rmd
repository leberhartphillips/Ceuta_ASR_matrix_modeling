# Overview
## Adult sex ratio bias is driven by sex-specific early survival: implications for population growth and mating system evolution
...
**`output/annual_estimates/`**

  - **survival_rates_year_age.txt** contains the stage- and year-specific survival estimates (*estimate*) of each year (*year*) in the study period. Each row represents a given stage (*age*) in a given year.

  - **survival_rates_year_age_sex.txt** contains the sex- stage-, and year-specific survival estimates (*estimate*) of each year (*year*) in the study period. Each row represents a given sex and stage (*sex_age*) in a given year.